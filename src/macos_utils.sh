...
# Reads the application version from changelog.txt.
# Falls back to "1.0.0" when the file is absent or unparseable.
get_version() {
    local VERSION="1.0.0"

    if [ -f "changelog.txt" ]; then
        VERSION=$(grep -E "^Version [0-9.]+" changelog.txt \
                  | head -1 \
                  | awk '{print $2}' \
                  | tr -d '\r')
        if [ -z "$VERSION" ]; then
...
# =============================================================================
# Section 4 -- Architecture Detection
# =============================================================================
...
# =============================================================================
# Section 5 -- Recursive Dependency Copying
# =============================================================================
...
# =============================================================================
# Section 6 -- High-Level Dependency Copy (copy_dylib)
# =============================================================================
...
# =============================================================================
# Section 7 -- Library Install-Name Fixup
# =============================================================================
...
# =============================================================================
# Section 10 -- File-System Utilities
# =============================================================================

# Safely removes a directory or symlink if it exists.
safe_rm_rf() {
    local path="$1"
...
# Verifies that a file exists.  Logs an error and returns 1 on failure.
verify_file() {
    local file="$1"
    local description="$2"
...
# Verifies that a directory exists.  Logs an error and returns 1 on failure.
verify_dir() {
    local dir="$1"
    local description="$2"
